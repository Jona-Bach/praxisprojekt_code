...
MIN_ROWS_FOR_MODEL = 50  # <--- NEU: Minimum an Zeilen für sinnvolles Training
...
def load_data_from_source(
    ...
    # NEU: automatische Konvertierung von String → float / datetime
    ...
    if train_button:
        if not feature_cols and not use_time_series:
            ...
            try:
                ...
                # NEU: Mindestanzahl an Zeilen checken
